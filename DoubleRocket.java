...
public class DoubleRocket extends GameObject {

    private final Handler handler;
    private HUD hud;

    public DoubleRocket(final int x, final int y, final ID id, final Handler handler) {
        super(x, y, id);
        this.handler = handler;

        velX = -3.0f * Game.DistMult;
    }
    ...
    public void render(final Graphics g) {
        ...
        try {
            image = ImageIO.read(new File("Game Assets/RocketForGame3.png"));
